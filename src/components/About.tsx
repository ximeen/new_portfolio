...
export function About(){
    return(
        <>
        <Header/>
        <section className="h-[80vh] lg:flex justify-center  items-center">
            <div className='lg:pr-40 items-center lg:items-start flex flex-col my-10'>
                <h1 className="text-gray-100 font-semibold text-3xl px-10">GABRIEL XIMENES <br/> <span className="text-cian-500">WEB ENGINEER</span></h1>
                <p className='max-w-lg text-gray-100 mt-8 px-10 lg:px-0 text-lg'>Tenho 18 anos,  comecei a estudar programação em março de 2021,
